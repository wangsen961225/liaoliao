...
import com.liaoliao.util.CommonKit;
...
public class toutiaoVideo {
	...
	public static void main(String[] args) {
		...
		String url_1 = "http://www.toutiao.com/api/pc/feed/?category=video&utm_source=toutiao&widen=1&max_behot_time=0&max_behot_time_tmp=0&tadrequire=true&as=A105F9B40B3556E&cp=594BC515C67ECE1/";
		String ref_1 = "http://www.toutiao.com/ch/video/";
		String resp = SpiderHttpKit.getToutiaoResp(url_1);
//		过滤emoji表情
...
//			maps.add((Map) parseArray.get(i));
			// 获取文章group_id
			System.out.println("视频group_id："+map.get("group_id"));
			System.out.println("视频类别："+map.get("chinese_tag"));
			System.out.println("视频类别码："+map.get("group_source"));
			System.out.println("视频image_url："+map.get("image_url"));
			System.out.println("视频来源："+map.get("source"));
			System.out.println("视频标题："+map.get("title"));
			System.out.println("视频描述："+map.get("abstract"));
			System.out.println("视频评论数："+map.get("comments_count"));
			System.out.println("视频播放数："+map.get("video_play_count"));
			System.out.println("视频标签："+map.get("tag"));
			System.out.println("视频类型："+map.get("article_genre"));
			System.out.println("视频时长："+map.get("video_duration_str"));
			System.out.println("视频唯一id："+map.get("video_id"));
			System.out.println("原始url："+"http://toutiao.com/group/"+map.get("video_id"));
			
			String urlBase = "http://i.snssdk.com/video/urls/1/toutiao/mp4/" + map.get("video_id");
			String videoResp = SpiderHttpKit.getToutiaoResp(urlBase);
//			过滤emoji表情
			videoResp = CommonUtil.emojiFilter(videoResp);
			...
			if(videoList.get("video_3")!=null){
				Map video3 = (Map) videoList.get("video_3");
			...
			else if(videoList.get("video_2")!=null){
				Map video2 = (Map) videoList.get("video_2");
			...
			else if(videoList.get("video_1")!=null){
				Map video1 = (Map) videoList.get("video_1");
